...
import { CS_BRIDGE_PHASES } from '@/lib/csBridge';
...
describe('cs bridge page', () => {
  ...
  it('renders phase and week expansion with required CS details', async () => {
    const user = userEvent.setup();
    render(<CSBridgePage />);

    expect(screen.getByText(/computer science bridge/i)).toBeTruthy();
    expect(screen.getByText(/phase 1: foundations/i)).toBeTruthy();
